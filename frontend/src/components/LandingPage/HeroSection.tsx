    ...
    <div className="h-max justify-start items-center flex flex-col mt-6 gap-2 md:gap-0 pointer-events-none select-none">
      <div className="text-center leading-[30px] md:leading-[40px] lg:leading-[50px] uppercase pointer-events-none select-none">
        <motion.span
          ...
          className=" text-white text-[clamp(24px,3.5vw,48px)] font-black font-['Satoshi Variable'] [text-shadow:_0px_0px_56px_rgb(147_93_202_/_0.35)] inline-block"
        >
          Missed out ?{" "}
        </motion.span>
        <motion.span
          ...
          className="pl-2 text-[#dc3912] text-[clamp(24px,3.5vw,48px)] font-bold font-['Satoshi Variable'] [text-shadow:_0px_0px_56px_rgb(147_93_202_/_0.35)] inline-block"
        >
          Find Tickets.
        </motion.span>
        <br />
      ...
      <motion.div
        ...
        className="text-center text-white/80 text-[clamp(16px,1.5vw,20px)] font-medium font-['Satoshi Variable'] leading-[20px] md:leading-[50px] tracking-wide md:mt-[-10px] lg:mt-[-10px]"
      >
