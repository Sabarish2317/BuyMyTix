    ...
    >
      <div className="image-container w-[80px] md:w-[100px] lg:w-[120px] h-full flex-shrink-0">
        <img
          ...
          src={titlesData.poster || getImageForType(titlesData)}
          alt="Poster"
        />
      </div>
      <div className="details-container w-full">
        <div className="w-full upper-details-container flex flex-col gap-2 items-center justify-start">
          <div className="title-and-language-container flex flex-row w-full gap-1 justify-between">
            <h2 className="text-white text-[clamp(16px,1.5vw,24px)] max-w-[150px] text-ellipsis font-medium pr-2">
              {titlesData.title}
            </h2>
            <h2 className="text-white text-[clamp(16px,1.2vw,20px)] w-max self-center font-regular pr-2 bg-white/10 py-2 px-3 rounded-md items-center justify-center ">
          ...
          <div className="profile-container flex flex-row gap-2 self-start items-center">
            <img
              ...
              src={sellerData.profileImage.data || "/icons/no-profile.png"}
              alt="profile"
            />
            <h3 className="text-[clamp(12px,1.2vw,16px)] text-white/80 font-medium">
              {sellerData.name}
