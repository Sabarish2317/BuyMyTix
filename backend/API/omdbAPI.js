...
const getMovie = async (Title, releaseYear, moviePoster, movieDescription, movieLanguage) => {
  ...
  try {
    ...
    if (movieData.Response === 'False') {
      return res.status(404).json({ message: 'Movie not found, Enter the detaiil manually' , error });
    }
